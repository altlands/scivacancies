...
namespace SciVacancies.WebApp.Controllers
{
    ...
    public class InitializeSubscriptionsController : Controller
    {
        private readonly IMediator _mediator;
        private readonly SciVacUserManager _userManager;

        public InitializeSubscriptionsController(SciVacUserManager userManager, IMediator mediator)
        {
        ...
        public IActionResult FillDb()
        {
            ...
            if (user == null)
            {
                ...
                result += "Пользователи инициализированы";
            }
            else
            {
                result += "Пользователи были инициализированы ранее";
            }
            ...
            if (_mediator.Send(new CountOrganizationsQuery()) == 0)
            {
                ...
                result += "Организации инициализированы";
            }
            else
            {
                result += "Организации были инициализированы ранее";
            }
        ...
        /// <summary>
        /// добавить вакансии для тестирования
        /// </summary>
        /// <param name="id">guid организации</param>
        /// <returns></returns>
        public IActionResult AddMoreVacancies(Guid id)
        {
            var rnd = new Random();

            if (id == Guid.Empty)
                return Content($"{nameof(id)} == Guid.Empty");

            var organizations = _mediator.Send(new SelectOrganizationsByGuidsQuery { OrganizationGuids = new List<Guid> { id } });

            if (organizations == null || !organizations.Any())
                return Content($"организация с GUID {id} не найдена");
            ...
            var vacancyGuid1 = _mediator.Send(new CreateVacancyCommand
            {
                ...
                Data = new VacancyDataModel
                {
                    ...
                    OrganizationFoivId = organization.foiv_id
                }
            });
            ...
            _mediator.Send(new PublishVacancyCommand
            {
                ...
                InCommitteeStartDate = DateTime.Now.AddMinutes(15),
                InCommitteeEndDate = DateTime.Now.AddMinutes(20)
            });
            ...
            return Content("Vacancies added");
        }
