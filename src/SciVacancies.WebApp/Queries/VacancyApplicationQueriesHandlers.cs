...
namespace SciVacancies.WebApp.Queries
{
    public class SingleVacancyApplicationQueryHandler : IRequestHandler<SingleVacancyApplicationQuery, VacancyApplication>
    {
        ...
        public VacancyApplication Handle(SingleVacancyApplicationQuery message)
        {
            ...
            VacancyApplication vacancyApplication = _db.SingleOrDefault<VacancyApplication>(new Sql($"SELECT va.* FROM \"VacancyApplications\" va WHERE va.\"Guid\"='{message.VacancyApplicationGuid}' AND va.\"Status\"!={(int)VacancyApplicationStatus.Removed}"));
